class para_RscDisplayBuildingMenu
{
	...
	class ControlsBackground
	{
		...
		{
			x = QUOTE(PARA_SHEET_R_X + UIW(1));
			y = QUOTE(PARA_SHEET_R_Y + PARA_SHEET_R_H - UIH(7.9));
			w = QUOTE(UIW(10));
			h = QUOTE(UIH(7));
			text = "";
	...
	class Controls
	{
		...
		{
			x = QUOTE(PARA_SHEET_L_X + UIW(1));
			y = QUOTE(PARA_SHEET_L_Y + UIH(0.2));
			w = QUOTE(PARA_SHEET_L_W - UIW(3));
			h = QUOTE(PARA_SHEET_L_H - UIH(3.5) + UIH(1.2));
			class Controls
			{
				...
				{
					x = 0;
					y = QUOTE(UIH(4.8) + UIH(1.2));
					w = QUOTE(PARA_SHEET_L_W - UIW(3));
					h = QUOTE(UIH(15.4));

					rowHeight = QUOTE(UIH(2.4));
					lineSpacing = QUOTE(UIH(0.1));
					...
					class RowTemplate
					{
						class RowBackground
						{
							...
							columnX = 0;
							columnW = QUOTE(PARA_SHEET_L_W - UIW(3));
							controlOffsetY = 0;
						};
						class Picture
						{
						...
						class Name
						{
							...
							columnX = QUOTE(UIW(5));
							columnW = QUOTE(PARA_SHEET_L_W - UIW(8));
							controlOffsetY = QUOTE(UIH(0.8));
						};
					};
				};
				...
				{
					x = 0;
					y = QUOTE(PARA_SHEET_L_H - UIH(4.5) + UIH(0.8));
					w = QUOTE((PARA_SHEET_L_W - UIW(3)) / 3);
					h = QUOTE(UIH(1));
				...
				class Next: Previous
				{
					x = QUOTE(((PARA_SHEET_L_W - UIW(3)) / 3) * 2);
				...
				{
					idc = 238298;
					x = QUOTE((PARA_SHEET_L_W - UIW(3)) / 3);
					y = QUOTE(PARA_SHEET_L_H - UIH(4.5) + UIH(0.8));
					w = QUOTE((PARA_SHEET_L_W - UIW(3)) / 3);
					h = QUOTE(UIH(1));
					sizeEx = QUOTE(TXT_S);
		...
		{
			x = QUOTE(PARA_SHEET_R_X + UIW(2.2));
			y = QUOTE(PARA_SHEET_R_Y + UIH(1));
			w = QUOTE(PARA_SHEET_R_W - UIW(3));
			h = QUOTE(PARA_SHEET_R_H - UIH(1.5));
			class Controls
			{
				class Title: para_RscText
				{
		...
		{
			x = QUOTE(PARA_SHEET_R_X + PARA_SHEET_R_W - UIW(7.8));
			y = QUOTE(PARA_SHEET_R_Y + PARA_SHEET_R_H - UIH(5.9));
			w = QUOTE(UIW(7.1));
			h = QUOTE(UIH(3));
