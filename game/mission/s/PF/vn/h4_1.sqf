...
_bag setPos(_b modelToWorld[-0.87, 2.28, 1.1]);
_bag setDir(_dir-95);

_box setPos(_b modelToWorld[-1, 2.27, 1.46]);
_box setDir(_dir-5);

_can setPos(_b modelToWorld[-1.12, 2.35, 1.07]);

_can2 setPos(_b modelToWorld[-1.25, 2.327, 1.07]);

_can3 setPos(_b modelToWorld[-1.19, 2.4, 1.07]);

_fak setPos(_b modelToWorld[-1.17, 2.21, 1.08]);
_fak setDir(_dir+65);

_pot setPos(_b modelToWorld[-0.5, -2.43, 1.3]);

_jug setPos(_b modelToWorld[-0.06, -2.37, 1.32]);

_sack setPos(_b modelToWorld[1.8, -1.3, 1.42]);
_sack setDir _dir;

_wall setPos(_b modelToWorld[-1.4, -1.78, 2.1]);
