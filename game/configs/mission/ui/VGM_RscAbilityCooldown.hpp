...
class VGM_RscAbilityCooldown
{
    ...
    class Controls
    {
        class MainLabel: RscText
        {
            ...
            x = QUOTE(DISPLAY_X);
            y = QUOTE(DISPLAY_Y - 1.3 * GUI_GRID_H);
            w = QUOTE(DISPLAY_W * GUI_GRID_W);
        ...
        class IconPrimary: RscPicture
        {
            ...
            x = QUOTE(DISPLAY_X);
            y = QUOTE(DISPLAY_Y);
            w = QUOTE(ICON_SIZE * GUI_GRID_W);
            h = QUOTE(ICON_SIZE * GUI_GRID_H);
        ...
        class SecondsPrimary: RscStructuredText
        {
            ...
            x = QUOTE(DISPLAY_X);
            y = QUOTE(DISPLAY_Y + (ICON_SIZE - 1) * GUI_GRID_H);
            w = QUOTE(ICON_SIZE * GUI_GRID_W);
            h = QUOTE(1 * GUI_GRID_H);
        };
        class IconUlimate: IconPrimary
        {
            ...
            x = QUOTE(DISPLAY_X + (ICON_SIZE + 0.5) * GUI_GRID_W);
        };
