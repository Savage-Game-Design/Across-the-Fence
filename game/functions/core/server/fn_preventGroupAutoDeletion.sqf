/*
    ...
    Example(s):
        vgm_core_lobbyGroup call vgm_s_fnc_preventGroupAutoDeletion
 */
...
if (_group getVariable ["vgm_s_core_preventGroupAutoDeletionEH", -1] > -1) exitWith {};

format ["Disabling auto deletion of group: %1", _group] call vgm_g_fnc_logDebug;

_group deleteGroupWhenEmpty false;
private _eh = _group addEventHandler ["Empty", {
    params ["_group"];
...
_group setVariable ["vgm_s_core_preventGroupAutoDeletionEH", _eh];
