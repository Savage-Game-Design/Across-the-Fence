/*
    ...
    Example(s):
        ["leveling", getPlayerUID player, {
            ...
            diag_log format ["Leveling data for %1 is: %2", _arguments, _data];
        }, getPlayerUID player] call vgm_s_fnc_db_get;
*/
...
[_key, _id, _fnc_handler, _arguments] call (missionNamespace getVariable [_fnc, {format ["Invalid DB function: %1", _fnc]}]) // return
