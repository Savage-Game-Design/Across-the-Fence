...
params ["_schema", "_id", "_data", "_fnc_handler", "_arguments"];

private _response = [format ["persistence:%1:set", _schema], [_id, _data]] call vgm_s_fnc_extension_call;
