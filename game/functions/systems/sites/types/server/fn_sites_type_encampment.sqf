...
/*
    File: fn_sites_types_encampment.sqf
    ...
    Description:
        Creates a new "Encampment" site type
    ...
    Example(s):
        ...
        # Alternatively:
        [
            []  call vgm_s_fnc_sites_type_encampment;
        ] call vgm_s_fnc_site_addSiteType;
 */

private _site = [] call vgm_s_fnc_sites_getTemplate;

_site set ["name", "STR_VGM_SITES_ENCAMPMENT"];
_site set ["size", SITE_FOOTPRINT_LARGE];
_site set ["locRequirements", ["flat", "covered"]];
