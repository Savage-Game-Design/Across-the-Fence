...
[format ["%1:get", _schema], {
    ...
    format ["Persistence DB get callback: %1, %2", _resultStr, _data] call vgm_g_fnc_logDebug;
...
// handle schema save
[format ["%1:set", _schema], {
    params ["_resultStr", "_data", "_args"];
    format ["Persistence DB set callback: %1, %2", _resultStr, _data] call vgm_g_fnc_logDebug;
    ...
    format ["Set persistence data for player: %1, %2", _playerUID, _schema] call vgm_g_fnc_logInfo;
    format ["Data: %1", _data] call vgm_g_fnc_logDebug;
