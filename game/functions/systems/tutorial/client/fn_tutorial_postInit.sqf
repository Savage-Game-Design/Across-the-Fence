...

{
    ...
    private _pagesWithHints = configProperties [_categoryConfig, "isClass _x && (isClass (_x >> 'Hints'))", true];
    {
        private _pageConfig = _x;
        private _triggerableTutorials = configProperties [_pageConfig, "isClass _x && (isClass (_x >> 'Triggers'))"];
        {
            ...
            if (_marker != "" && markerPos _marker isNotEqualTo [0, 0, 0]) then {
                ...
                _trigger setTriggerStatements [
                    "player in thisList",
                    format ["['%1', '%2', '%3'] call vgm_c_fnc_tutorial_trigger;", configName _categoryConfig, configName _pageConfig, configName _hintConfig],
                    ""
                ];
            };
            ...
            if (_event != "") then {
                [
                    _event,
                    [
                        [configName _categoryConfig, configName _pageConfig, configName _hintConfig], {
