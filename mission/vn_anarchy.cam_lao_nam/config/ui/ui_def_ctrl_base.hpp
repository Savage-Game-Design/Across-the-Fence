...
class vn_mf_RscButton_ImgSwitch
{
	...
	onMouseEnter = "[1,(_this#0)] call para_fnc_ui_updateImg;"; //IMPORTANT! DON'T TOUCH OR OVERWRITE! //
	onMouseExit = "[0,(_this#0)] call para_fnc_ui_updateImg;";	 //IMPORTANT! DON'T TOUCH OR OVERWRITE! //
	/////////////////// IMPORTANT! DON'T TOUCH OR OVERWRITE! /////////////////////////////////////////////
...
class vn_mf_RscControlsGroup : RscControlsGroup
{
	x = 0;
	y = 0;
	w = 0;
