 ...
 *
 *    Taken from official-antistasi-community/A3-Antistasi (MIT License). Also, I wrote it there originally, so no copyright issues.
 * Params:
 *    _vehicle - Vehicle to test (in correct orientation)
 *    _targetPos - position to move vehicle to
 * Returns:
