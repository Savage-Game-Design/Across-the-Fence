...
_taskDataStore setVariable ["INIT", {
	...
	_taskDataStore setVariable ["posToReturnTo", getArray (_taskParameters >> "posToReturnTo") call vn_mf_fnc_parse_pos_config];
...
_taskDataStore setVariable ["find_aircrew", {
	...
	private _validRescueUnits = units (missionNamespace getVariable "SpikeTeam");
