...
diag_log [":::: CREATE_CRATE: DATA:", ["call_function", ["crate_add",[_tmpKey, _model, [_pos,_dir] , _gridSize]]]];

"asc_extension" callExtension ["call_function", ["crate_add",[_tmpKey, _model, [_pos,_dir] , _gridSize]]];
